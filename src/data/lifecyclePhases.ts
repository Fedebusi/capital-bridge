    ...
    phases: [
      {
        ...
        substeps: [
          { id: "o1", label: "Teaser/IM received from broker", description: "Information memorandum received", status: "completed", completedDate: "2025-04-10", assignee: "M. Rivera" },
          { id: "o2", label: "Initial screening against fund criteria", description: "LTV, LTC, location, asset type, ticket size check", status: "completed", completedDate: "2025-04-12", assignee: "A. Delgado" },
          { id: "o3", label: "Preliminary financial analysis", description: "Quick model to validate returns", status: "completed", completedDate: "2025-04-14", assignee: "L. Campos" },
          { id: "o4", label: "Indication of interest issued", description: "Non-binding IOI sent to borrower", status: "completed", completedDate: "2025-04-15", assignee: "M. Rivera" },
        ],
      },
      {
        ...phaseDefinitions[1], status: "completed", startDate: "2025-04-15", completedDate: "2025-05-15",
        milestones: [
          { description: "Term sheet validado por Capital Partner", achieved: true, achievedDate: "2025-04-28", evidence: "Capital Partner approval email" },
        ...
        substeps: [
          { id: "ts1", label: "Draft term sheet preparation", description: "Internal draft with key terms", status: "completed", completedDate: "2025-04-15", assignee: "M. Rivera" },
          { id: "ts2", label: "Internal review (legal + credit)", description: "Legal and credit team review", status: "completed", completedDate: "2025-04-22", assignee: "P. Serrano" },
          { id: "ts3", label: "Capital Partner memo & model submitted", description: "Preliminary memo and model for CP validation", status: "completed", completedDate: "2025-04-25", assignee: "R. Medina" },
          { id: "ts4", label: "Capital Partner validation received", description: "CP approved with conditions", status: "completed", completedDate: "2025-04-28", assignee: "K. Walsh (Capital Partner)" },
          { id: "ts5", label: "Term sheet issued to borrower", description: "Indicative term sheet sent", status: "completed", completedDate: "2025-04-28", assignee: "M. Rivera" },
          ...
          { id: "ts7", label: "Term sheet signed by borrower", description: "Borrower accepts terms", status: "completed", completedDate: "2025-05-15", assignee: "Solaris Promociones SL" },
        ],
      },
      {
        ...
        substeps: [
          { id: "dd1", label: "Technical & urban planning DD", description: "Licenses, soil survey, construction budget review", status: "completed", completedDate: "2025-05-01", assignee: "C. Moreno" },
          { id: "dd2", label: "Commercial / market DD", description: "Comparables, absorption, pre-sales verification", status: "completed", completedDate: "2025-05-15", assignee: "S. Vidal" },
          { id: "dd3", label: "Independent valuation (ECO)", description: "Current and GDV appraisal", status: "completed", completedDate: "2025-05-12", assignee: "Apex Valuation" },
          { id: "dd4", label: "Legal DD", description: "Title, corporate structure, litigation, contracts", status: "completed", completedDate: "2025-05-08", assignee: "Bufete Ibérico" },
          { id: "dd5", label: "Financial & developer DD", description: "Financials, track record, cash flow model, stress test", status: "completed", completedDate: "2025-05-08", assignee: "T. Aguirre" },
      ...
      },
      {
        ...
        milestones: [
          ...
          { description: "Sign-off de Capital Partner", achieved: true, achievedDate: "2025-06-10", evidence: "Capital Partner approval letter" },
        ],
        substeps: [
          { id: "ic1", label: "Credit paper prepared & distributed", description: "Investment memorandum sent to IC members", status: "completed", completedDate: "2025-05-30", assignee: "V. Ramos" },
          ...
          { id: "ic4", label: "Capital Partner sign-off obtained", description: "Capital partner final approval", status: "completed", completedDate: "2025-06-10", assignee: "N. Hartmann (Capital Partner)" },
        ],
      },
      {
        ...
        substeps: [
          { id: "ld1", label: "Facility agreement negotiation", description: "Loan agreement with all clauses", status: "completed", completedDate: "2025-07-10", assignee: "Bufete Ibérico" },
          { id: "ld2", label: "Mortgage deed preparation", description: "First-ranking mortgage over the asset", status: "completed", completedDate: "2025-07-15", assignee: "Notaría Central" },
          { id: "ld3", label: "Share pledge execution", description: "Pledge over SPV and sponsor shares", status: "completed", completedDate: "2025-07-12", assignee: "Bufete Ibérico" },
          { id: "ld4", label: "Project account agreement", description: "Escrow / project account setup", status: "completed", completedDate: "2025-07-08", assignee: "Banco Nacional" },
          { id: "ld5", label: "Direct agreement with constructor", description: "Step-in rights for the fund", status: "completed", completedDate: "2025-07-14", assignee: "Bufete Ibérico" },
          { id: "ld6", label: "Corporate & personal guarantees", description: "UBO personal guarantee executed", status: "completed", completedDate: "2025-07-10", assignee: "Bufete Ibérico" },
        ],
      },
      {
        ...
        substeps: [
          { id: "cp1", label: "Building license verified", description: "Valid licencia de obras", status: "completed", completedDate: "2025-06-20", assignee: "C. Moreno" },
          { id: "cp2", label: "Construction insurance in place", description: "All-risk + RC + decenal", status: "completed", completedDate: "2025-06-25", assignee: "D. Herrero" },
          { id: "cp3", label: "Project account opened", description: "Operational project account", status: "completed", completedDate: "2025-06-22", assignee: "T. Aguirre" },
          { id: "cp4", label: "Developer equity contributed", description: "Min 20% equity in", status: "completed", completedDate: "2025-06-28", assignee: "T. Aguirre" },
          { id: "cp5", label: "Construction contract signed", description: "Signed contract with main contractor", status: "completed", completedDate: "2025-06-30", assignee: "D. Herrero" },
          { id: "cp6", label: "All security docs executed", description: "Mortgage, pledges, guarantees registered", status: "completed", completedDate: "2025-07-15", assignee: "D. Herrero" },
      ...
      },
      {
        ...
        substeps: [
          { id: "dc1", label: "Monthly site inspections", description: "Monitoring surveyor visits & reports", status: "in_progress", assignee: "Ing. Y. Soto" },
      ...
      },
      {
        ...
        substeps: [
          ...
          { id: "mr3", label: "Quarterly reporting to Capital Partner", description: "Portfolio report with metrics", status: "in_progress", assignee: "R. Medina" },
          { id: "mr4", label: "Project account cash flow control", description: "Monitoring fund flows", status: "in_progress", assignee: "T. Aguirre" },
        ],
      },
      {
        ...
        substeps: [
          ...
          { id: "cm2", label: "Buyer quality assessment", description: "Profile of buyers (individuals, investors)", status: "in_progress", assignee: "S. Vidal" },
    ...
    phases: [
      {
        ...
        substeps: [
          { id: "o1", label: "Teaser received", description: "Information memorandum received", status: "completed", completedDate: "2026-03-01", assignee: "A. Delgado" },
          { id: "o2", label: "Initial screening passed", description: "Criteria check", status: "completed", completedDate: "2026-03-03", assignee: "A. Delgado" },
          { id: "o3", label: "IOI issued", description: "Non-binding indication", status: "completed", completedDate: "2026-03-05", assignee: "M. Rivera" },
        ],
      },
      {
        ...phaseDefinitions[1], status: "completed", startDate: "2026-03-10", completedDate: "2026-03-22",
        milestones: [
          { description: "Term sheet emitido (pendiente validación Capital Partner)", achieved: true, achievedDate: "2026-03-22" },
        ],
        substeps: [
          { id: "ts1", label: "Draft term sheet", description: "Initial draft", status: "completed", completedDate: "2026-03-10", assignee: "A. Delgado" },
          { id: "ts2", label: "Internal review", description: "Credit team review", status: "completed", completedDate: "2026-03-18", assignee: "L. Campos" },
          { id: "ts3", label: "Submitted to Capital Partner", description: "Memo attached, model pending", status: "completed", completedDate: "2026-03-20", assignee: "R. Medina", notes: "Financial model not yet attached" },
          { id: "ts4", label: "Capital Partner validation", description: "Awaiting response", status: "in_progress", assignee: "Capital Partner" },
        ],
      },
      {
        ...
        substeps: [
          { id: "dd1", label: "Technical & urban planning DD", description: "License verification in progress", status: "in_progress", assignee: "U. Prieto" },
          { id: "dd2", label: "Commercial / market DD", description: "Market analysis underway", status: "in_progress", assignee: "W. Lara" },
          { id: "dd3", label: "Independent valuation", description: "Pending", status: "not_started" },
          { id: "dd4", label: "Legal DD", description: "Title search complete, SPV review ongoing", status: "in_progress", assignee: "Despacho Meridional" },
          { id: "dd5", label: "Financial & developer DD", description: "FLAGGED — Missing FY2025 audited accounts", status: "blocked", assignee: "X. Franco", notes: "Missing FY2025 audited accounts — requested from borrower" },
    ...
    phases: [
      {
        ...
        substeps: [{ id: "o1", label: "Screening & IOI", description: "Quick turnaround", status: "completed", completedDate: "2026-02-20", assignee: "M. Rivera" }],
      },
      {
        ...
        substeps: [
          { id: "ts1", label: "Term sheet drafted & approved by Capital Partner", description: "Fast-track", status: "completed", completedDate: "2026-03-08", assignee: "M. Rivera" },
          { id: "ts2", label: "Term sheet signed", description: "Borrower signed", status: "completed", completedDate: "2026-03-15", assignee: "Levantina Homes SL" },
        ],
      },
      {
      ...
      },
      {
        ...
        milestones: [
          { description: "IC aprobación — pending Capital Partner sign-off", achieved: false },
        ],
        substeps: [
          ...
          { id: "ic2", label: "Submitted to Capital Partner", description: "Awaiting sign-off", status: "in_progress", assignee: "J. Castillo" },
        ],
      },

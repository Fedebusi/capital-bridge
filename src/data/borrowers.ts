...
export const sampleBorrowers: Borrower[] = [
  {
    id: "bor-001",
    name: "Luminara Promociones SL",
    group: "Grupo Montalbán Inversiones",
    type: "Developer",
    internalRating: "A",
    ratingDate: "2025-03-15",
    headquarters: "Marbella, Málaga",
    yearEstablished: 2009,
    website: "www.montalban-inversiones.es",
    ...
    contacts: [
      { name: "Ricardo Montalbán", role: "CEO & UBO", email: "r.montalban@montalban-inv.es", phone: "+34 952 XXX XXX" },
      { name: "Elena Montalbán", role: "CFO", email: "e.montalban@montalban-inv.es", phone: "+34 952 XXX XXX" },
      { name: "Javier Ortega", role: "Head of Construction", email: "j.ortega@luminara.es", phone: "+34 652 XXX XXX" },
    ],
    corporateStructure: [
      { name: "Grupo Montalbán Inversiones SL", type: "Holding", jurisdiction: "Spain", registrationNumber: "B-29XXXXXX", ownership: "100% Montalbán Family" },
      { name: "Luminara Promociones SL", type: "SPV", jurisdiction: "Spain", registrationNumber: "B-29XXXXXX", ownership: "100% Grupo Montalbán" },
      { name: "Montalbán Family Office SL", type: "Sponsor", jurisdiction: "Spain", registrationNumber: "B-29XXXXXX" },
      { name: "Ricardo Montalbán Gutiérrez", type: "UBO", jurisdiction: "Spain", ownership: "85% beneficial ownership" },
    ],
    kyc: [
      ...
      { item: "Audited Financial Statements", status: "valid", lastChecked: "2025-06-20", notes: "FY2024 audited by Deloitte" },
    ],
    completedProjects: [
  ...
  {
    id: "bor-002",
    name: "Canillejas Residencial SL",
    group: "Velázquez Capital Partners",
    type: "Developer & Sponsor",
    internalRating: "B",
    ratingDate: "2026-02-20",
    headquarters: "Madrid",
    yearEstablished: 2015,
    description: "Madrid-focused residential developer with growing track record. Part of Velázquez Capital group with interests in residential and mixed-use developments across central Spain.",
    contacts: [
      { name: "Fernando Velázquez", role: "Managing Partner", email: "f.velazquez@velazquezcap.es", phone: "+34 915 XXX XXX" },
      { name: "Carmen Iglesias", role: "Finance Director", email: "c.iglesias@velazquezcap.es", phone: "+34 915 XXX XXX" },
    ],
    corporateStructure: [
      { name: "Velázquez Capital Partners SL", type: "Sponsor", jurisdiction: "Spain", registrationNumber: "B-28XXXXXX", ownership: "60% F. Velázquez, 40% institutional" },
      { name: "Canillejas Residencial SL", type: "SPV", jurisdiction: "Spain", registrationNumber: "B-28XXXXXX", ownership: "100% Velázquez Capital" },
      { name: "Fernando Velázquez Romero", type: "UBO", jurisdiction: "Spain", ownership: "60% beneficial ownership" },
    ],
    kyc: [
  ...
  {
    id: "bor-003",
    name: "Ruzafa Homes SL",
    group: "Levante Desarrollos Inmobiliarios",
    type: "Developer",
    internalRating: "A",
    ...
    contacts: [
      { name: "Andrés Pascual", role: "CEO", email: "a.pascual@levantedesarrollos.es", phone: "+34 963 XXX XXX" },
      { name: "Lucía Ferrer", role: "Commercial Director", email: "l.ferrer@levantedesarrollos.es", phone: "+34 963 XXX XXX" },
      { name: "Miguel Soriano", role: "Technical Director", email: "m.soriano@levantedesarrollos.es", phone: "+34 648 XXX XXX" },
    ],
    corporateStructure: [
      { name: "Levante Desarrollos Inmobiliarios SA", type: "Holding", jurisdiction: "Spain", registrationNumber: "A-46XXXXXX", ownership: "Pascual Family (70%), Institutional (30%)" },
      { name: "Ruzafa Homes SL", type: "SPV", jurisdiction: "Spain", registrationNumber: "B-46XXXXXX", ownership: "100% Levante Desarrollos" },
      { name: "Andrés Pascual García", type: "UBO", jurisdiction: "Spain", ownership: "70% through family holding" },
    ],
    kyc: [
      ...
      { item: "Audited Financial Statements", status: "valid", lastChecked: "2025-09-20", notes: "FY2024 audited by PwC" },
  ...
  },
  {
    ...
    contacts: [
      { name: "Pol Casanova", role: "Founder & CEO", email: "p.casanova@oreneta.es", phone: "+34 934 XXX XXX" },
      { name: "Nuria Almirall", role: "Project Manager", email: "n.almirall@oreneta.es", phone: "+34 672 XXX XXX" },
    ],
    corporateStructure: [
      { name: "Oreneta Group SL", type: "Sponsor", jurisdiction: "Spain", registrationNumber: "B-08XXXXXX", ownership: "Casanova Family (80%), Angel investors (20%)" },
      { name: "Gràcia Heritage SL", type: "SPV", jurisdiction: "Spain", registrationNumber: "B-08XXXXXX", ownership: "100% Oreneta Group" },
      { name: "Pol Casanova Puig", type: "UBO", jurisdiction: "Spain", ownership: "80% beneficial ownership" },
    ],
    kyc: [
  ...
  {
    id: "bor-005",
    name: "Port Vell Residences SL",
    group: "Tramuntana Real Estate",
    type: "Developer & Sponsor",
    internalRating: "B",
    ...
    contacts: [
      { name: "Bartomeu Serra", role: "Managing Director", email: "b.serra@tramuntana-re.es", phone: "+34 971 XXX XXX" },
      { name: "Margalida Fiol", role: "CFO", email: "m.fiol@tramuntana-re.es", phone: "+34 971 XXX XXX" },
    ],
    corporateStructure: [
      { name: "Tramuntana Real Estate SL", type: "Sponsor", jurisdiction: "Spain", registrationNumber: "B-07XXXXXX", ownership: "Serra Family (65%), Private investors (35%)" },
      { name: "Port Vell Residences SL", type: "SPV", jurisdiction: "Spain", registrationNumber: "B-07XXXXXX", ownership: "100% Tramuntana RE" },
      { name: "Bartomeu Serra Crespí", type: "UBO", jurisdiction: "Spain", ownership: "65% beneficial ownership" },
    ],
    kyc: [
      ...
      { item: "Audited Financial Statements", status: "valid", lastChecked: "2025-08-15", notes: "FY2024 audited by EY" },
      { item: "PEP Screening", status: "valid", lastChecked: "2026-01-15", expiryDate: "2026-07-15" },
    ],
    completedProjects: [
